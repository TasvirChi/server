...
class BorhanMonitorResult
{
	...
	public function toXml()
	{
		...
		{
			if($error instanceof BorhanMonitorError && $error->level != null)
			{
	...
	public static function fromXml($xmlString)
	{
		...
		if($xml->error != null)
		{
			...
			{
				$monitorErr = new BorhanMonitorError();
