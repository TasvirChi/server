...
if(!defined("BorhanBatchJobStatus::$statusConst"))
{
	echo "Argument status [$statusConst] is invalid, only BorhanBatchJobStatus constants are acceptable";
	exit(-1);
}
$status = constant("BorhanBatchJobStatus::$statusConst");
...
if(!defined("BorhanBatchJobType::$jobTypeConst"))
{
	echo "Argument job-type [$jobTypeConst] is invalid, only BorhanBatchJobStatus constants are acceptable";
	exit(-1);
}
$jobType = constant("BorhanBatchJobType::$jobTypeConst");
