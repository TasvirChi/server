...
try
{
	...
	$replaceQuery = "replace into borhan_entry (id, entry_id, str_entry_id) values(1, \'MONITOR_TEST\', \'$updatedEntryId\')";
	...
	$selectQuery = "select str_entry_id from borhan_entry where id = 1";
