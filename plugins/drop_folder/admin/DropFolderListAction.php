 ...
 * @subpackage Admin
 */
class DropFolderListAction extends BorhanApplicationPlugin implements IBorhanAdminConsolePublisherAction
{
	...
	{
		return array(Borhan_Client_Enum_PermissionName::SYSTEM_ADMIN_DROP_FOLDER_BASE);
	}
	...
	{
		$filter = new Borhan_Client_DropFolder_Type_DropFolderFilter();
