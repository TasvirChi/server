 ...
 * @subpackage Admin
 */
class DrmProfileListAction extends BorhanApplicationPlugin implements IBorhanAdminConsolePublisherAction
{
	...
	{
		return array(Borhan_Client_Enum_PermissionName::SYSTEM_ADMIN_DRM_PROFILE_BASE);
	}
	...
	{
		$filter = new Borhan_Client_Drm_Type_DrmProfileFilter();
