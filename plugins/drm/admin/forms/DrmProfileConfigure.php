...
class Form_DrmProfileConfigure extends Infra_Form
{
	...
	public function init()
	{
		...
		$providerForView = new Borhan_Form_Element_EnumSelect('typeForView', array('enum' => 'Borhan_Client_Drm_Enum_DrmProviderType'));
		...
		$extendTypeSubForm = BorhanPluginManager::loadObject('Form_DrmProfileConfigureExtend_SubForm', $this->drmProfileProvider);
	...
	public function getObject($objectType, array $properties, $add_underscore = true, $include_empty_fields = false)
	{
	    ...
	    $object = BorhanPluginManager::loadObject('Borhan_Client_Drm_Type_DrmProfile', $properties['provider']);
