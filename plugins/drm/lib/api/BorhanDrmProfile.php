 ...
 */
class BorhanDrmProfile extends BorhanObject implements IFilterable
{	
	/**
	 * @var int
	 * @readonly
	...
	static function getInstanceByType ($provider)
	{
        ...
        {
            return new BorhanDrmProfile();
        }
        $obj = BorhanPluginManager::loadObject('BorhanDrmProfile', $provider);
		return $obj;
	}
