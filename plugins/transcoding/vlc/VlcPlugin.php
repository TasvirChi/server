 ...
 * @package plugins.vlc
 */
class VlcPlugin extends BorhanPlugin implements IBorhanObjectLoader, IBorhanEnumerator
{
	...
	{
		if($baseClass == 'KOperationEngine' && $enumValue == BorhanConversionEngineType::VLC)
		{
