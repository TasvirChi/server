 ...
 */
class QuickTimeToolsPlugin extends BorhanPlugin implements IBorhanObjectLoader, IBorhanEnumerator
{
	...
	{
		if($baseClass == 'KOperationEngine' && $enumValue == BorhanConversionEngineType::QUICK_TIME_PLAYER_TOOLS)
		{
