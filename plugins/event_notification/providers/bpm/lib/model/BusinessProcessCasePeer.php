...
class BusinessProcessCasePeer extends BaseBusinessProcessCasePeer {
	...
	{
		BorhanLog::info ("Retrieving cases for object ID [$objectId], object type [$objectType]");
	...
	{
		BorhanLog::info ("Retrieving cases for object ID [$objectId], object type [$objectType], server Id [$serverId], process ID [$processId]");
		$criteria = new Criteria ();
