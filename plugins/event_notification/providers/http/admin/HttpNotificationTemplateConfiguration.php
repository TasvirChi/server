...
class Form_HttpNotificationTemplateConfiguration extends Form_EventNotificationTemplateConfiguration
{
	...
	public function getObject($objectType, array $properties, $add_underscore = true, $include_empty_fields = false)
	{
		...
		if($object instanceof Borhan_Client_HttpNotification_Type_HttpNotificationTemplate)
		{
			...
			{
				case 'object':
					$object->data = new Borhan_Client_HttpNotification_Type_HttpNotificationObjectData();
				...
				case 'map':
					$object->data = new Borhan_Client_HttpNotification_Type_HttpNotificationDataFields();
					break;
					
				case 'text':
					$stringField = new Borhan_Client_Type_StringValue();
					$stringField->value = $properties['freeText'];
					
					$object->data = new Borhan_Client_HttpNotification_Type_HttpNotificationDataText();
	...
	public function populateFromObject($object, $add_underscore = true)
	{
		...
		if($object->data instanceof Borhan_Client_HttpNotification_Type_HttpNotificationDataFields)
		{
			$this->getElement('dataType')->setValue('map');
		}
		elseif($object->data instanceof Borhan_Client_HttpNotification_Type_HttpNotificationDataText)
		{
			$this->getElement('dataType')->setValue('text');
			$this->getElement('freeText')->setValue($object->data->content->value);
		}
		elseif($object->data instanceof Borhan_Client_HttpNotification_Type_HttpNotificationObjectData)
		{
