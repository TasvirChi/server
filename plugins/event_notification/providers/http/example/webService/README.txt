...
1. Update session config:
	at NewNotificationHandler/src/lib/Borhan/config/SessionConfig.java
	Please update the partner_id, admin_secret & service_url

2. Update Sync sample handler:
	at NewNotificationHandler/src/lib/Borhan/notification/handlers/SyncSampleHandler.java
