 ...
 * @subpackage admin
 */
class EventNotificationTemplatesListAction extends BorhanApplicationPlugin implements IBorhanAdminConsolePublisherAction
{
	...
	{
		return array(Borhan_Client_Enum_PermissionName::SYSTEM_ADMIN_EVENT_NOTIFICATION_BASE);
	}
	
	/**
	 * @param Zend_Controller_Request_Abstract $request
	 * @return Borhan_Client_Type_PartnerFilter
	 */
	...
	public function doAction(Zend_Controller_Action $action)
	{
		...
		$listTemplatespager = new Borhan_Client_Type_FilterPager();
	...
	/* (non-PHPdoc)
	 * @see IBorhanAdminConsolePublisherAction::getPublisherAdminActionOptions()
	 */
	...
	/* (non-PHPdoc)
	 * @see IBorhanAdminConsolePublisherAction::getPublisherAdminActionJavascript()
	 */
