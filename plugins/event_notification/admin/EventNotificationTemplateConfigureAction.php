 ...
 * @subpackage admin
 */
class EventNotificationTemplateConfigureAction extends BorhanApplicationPlugin
{
	protected $client;
	...
	public function doAction(Zend_Controller_Action $action)
	{
		...
		$eventNotificationPlugin = Borhan_Client_EventNotification_Plugin::get($this->client);
		...
		try
		{
			...
			$form = BorhanPluginManager::loadObject('Form_EventNotificationTemplateConfiguration', $type, array($partnerId, $type));
			/* @var $form Form_EventNotificationTemplateConfiguration */
			$templateClass = BorhanPluginManager::getObjectClass('Borhan_Client_EventNotification_Type_EventNotificationTemplate', $type);
