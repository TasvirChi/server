 ...
 */
class AnnotationEventNotificationsPlugin extends BorhanPlugin implements IBorhanPending, IBorhanEnumerator, IBorhanObjectLoader
{
	...
	public static function dependsOn()
	{
		...
		$annotationDependency = new BorhanDependency(self::ANNOTATION_PLUGIN_NAME);
