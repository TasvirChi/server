 ...
 */
class CaptionAssetEventNotificationsPlugin extends BorhanPlugin implements IBorhanPending, IBorhanEnumerator, IBorhanObjectLoader
{
	...
	public static function dependsOn()
	{
		...
		$captionAssetDependency = new BorhanDependency(self::CAPTION_ASSET_PLUGIN_NAME);
