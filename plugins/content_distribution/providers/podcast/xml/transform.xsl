...
exclude-result-prefixes="xs">
	...
	version="2.0">
		<xsl:for-each select="rss">
		   <channel>
				...
				<generator>Borhan - Open Source Video</generator>
				<ttl>60</ttl>
				...
				<itunes:image href="http://corp.borhan.com/images/header/borhanLogo.png" />
  ...
  <xsl:template name="item" match="item">
	...
	<xsl:variable name="server" select="'http://www.borhan.com'" />
		<item>
			<title>
				<xsl:choose>
