...
{
	/**
	 * @var Borhan_Client_MsnDistribution_Type_MsnDistributionProfile
	 */
	...
	public function getObject($objectType, array $properties, $add_underscore = true, $include_empty_fields = false)
	{
		...
		/* @var $object Borhan_Client_MsnDistribution_Type_MsnDistributionProfile */
	...
	protected function addFlavorsSelect(Borhan_Client_Type_FlavorParamsListResponse $flavorParams, $name, $label)
	{
