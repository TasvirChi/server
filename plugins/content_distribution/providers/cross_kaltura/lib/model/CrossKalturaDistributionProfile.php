 ...
 * @subpackage model
 */
class CrossBorhanDistributionProfile extends ConfigurableDistributionProfile
{
	// custom data fields
	...
	{
		return CrossBorhanDistributionPlugin::getProvider();
	}
	...
	{	    
	    ...
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_NAME);
	    ...
	    // entry description
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_DESCRIPTION);
	    ...
	    // entry user id
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_USER_ID);
	    ...
	    // entry tags
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_TAGS);
	    ...
	    // entry categories
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_CATEGORIES);
	    ...
	    // entry partner data
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_PARTNER_DATA);
	    ...
	    // entry start date
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_START_DATE);
	    ...
	    // entry end date
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_END_DATE);
	    ...
	    // entry reference id
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_REFERENCE_ID);
	    ...
	    // entry license type
	    $fieldConfig = new DistributionFieldConfig();
	    $fieldConfig->setFieldName(CrossBorhanDistributionField::BASE_ENTRY_LICENSE_TYPE);
