...
class Form_TvinciProfileConfiguration extends Form_ConfigurableProfileConfiguration
{
	...
	public function getObject($objectType, array $properties, $add_underscore = true, $include_empty_fields = false)
	{
		...
		/**
		 * @var Borhan_Client_TvinciDistribution_Type_TvinciDistributionProfile $object
		 */
		$tagsArr = array();
		foreach($properties as $key => $value)
		{
			...
			{
				$tvinciDistributionTag = new Borhan_Client_TvinciDistribution_Type_TvinciDistributionTag();
		...
		if($object instanceof Borhan_Client_TvinciDistribution_Type_TvinciDistributionProfile) {
