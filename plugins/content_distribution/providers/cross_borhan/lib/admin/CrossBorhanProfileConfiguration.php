 ...
 * @subpackage admin
 */
class Form_CrossBorhanProfileConfiguration extends Form_ConfigurableProfileConfiguration
{
	...
	{
		parent::init();
		$this->setDescription('Cross Borhan Distribution Profile');
		$this->getView()->addBasePath(realpath(dirname(__FILE__)));
		$this->addDecorator('ViewScript', array(
			'viewScript' => 'cross-borhan-distribution.phtml',
			'placement' => 'APPEND'
		));
	}
	...
	protected function addProviderElements()
	{
		...
		$element->setLabel('Cross Borhan Specific Configuration');
	...
	{
		/* @var $object Borhan_Client_CrossBorhanDistribution_Type_CrossBorhanDistributionProfile */
		$object = parent::getObject($objectType, $properties, $add_underscore, true);
        
		// transform the regular metadataXpathsTriggerUpdate array to a BorhanStringValueArray
		$xpathsBorhanArray = array();
		...
		{
		    $xpathStringValue = new Borhan_Client_Type_StringValue();
		    $xpathStringValue->value = $xpath;
		    $xpathsBorhanArray[] = $xpathStringValue;
		}
		$object->metadataXpathsTriggerUpdate = $xpathsBorhanArray;
	...
	{
        /* @var Borhan_Client_CrossBorhanDistribution_Type_CrossBorhanDistributionProfile $object */
		parent::populateFromObject($object, $add_underscore);
		
		// transform the BorhanStringValue array to a normal array
		$xpathsArray = array();
