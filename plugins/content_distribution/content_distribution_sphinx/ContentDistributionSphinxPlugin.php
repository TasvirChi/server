 ...
 */
class ContentDistributionSphinxPlugin extends BorhanPlugin implements IBorhanCriteriaFactory, IBorhanSphinxConfiguration
{
	...
	public static function getSphinxSchema()
	{
		return array(
			kSphinxSearchManager::getSphinxIndexName('entry_distribution') => array (	
				'path'		=> '/sphinx/borhan_distribution_rt',
				'fields'	=> array(
