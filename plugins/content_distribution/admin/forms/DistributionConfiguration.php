...
class Form_DistributionConfiguration extends Infra_Form
{
	public function getObject($objectType, array $properties, $add_underscore = true, $include_empty_fields = false)
	{
		...
		foreach($properties as $property => $value)
		{
			...
			if(preg_match('/dimensionsWidth_(\d+)$/', $property, $matches))
			{
				...
				$dimensions = new Borhan_Client_ContentDistribution_Type_DistributionThumbDimensions();
		...
		foreach($properties as $key => $value)
		{
			...
			{
				$assetDistributionRule = new Borhan_Client_ContentDistribution_Type_AssetDistributionRule();
				...
				foreach($value as $subKey => $subValue)
				{
					...
					{
						$assetDistributionPropertyCondition = new Borhan_Client_ContentDistribution_Type_AssetDistributionPropertyCondition();
	...
	public function addFlavorParamsFields(Borhan_Client_Type_FlavorParamsListResponse $flavorParams, array $optionalFlavorParamsIds = array(), array $requiredFlavorParamsIds = array())
	{
	...
	public function addThumbDimensions(Borhan_Client_ContentDistribution_Type_DistributionThumbDimensions $dimensions, $isRequired)
	{
