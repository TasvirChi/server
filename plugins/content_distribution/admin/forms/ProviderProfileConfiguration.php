...
{
	/**
	 * @var Borhan_Client_ContentDistribution_Type_DistributionProfile
	 */
	...
	/**
	 * @var Borhan_Client_ContentDistribution_Enum_DistributionProviderType
	 */
	protected $providerType;
	
	public function __construct($partnerId, $providerType, Borhan_Client_ContentDistribution_Type_DistributionProfile $distributionProfile = null)
	{
	...
	public function saveProviderAdditionalObjects(Borhan_Client_ContentDistribution_Type_DistributionProfile $distributionProfile)
	{
...
//		));
	...
	protected function addProfileAction($action)
	{
		...
		$element->addMultiOption(Borhan_Client_ContentDistribution_Enum_DistributionProfileActionStatus::DISABLED, 'Disabled');
		$element->addMultiOption(Borhan_Client_ContentDistribution_Enum_DistributionProfileActionStatus::MANUAL, 'Manual');
		$element->addMultiOption(Borhan_Client_ContentDistribution_Enum_DistributionProfileActionStatus::AUTOMATIC, 'Automatic');
	...
	protected function addMetadataProfile($enableNone = false)
	{
		...
		try
		{
			$metadataProfileFilter = new Borhan_Client_Metadata_Type_MetadataProfileFilter();
			$metadataProfileFilter->metadataObjectTypeEqual = Borhan_Client_Metadata_Enum_MetadataObjectType::ENTRY;
