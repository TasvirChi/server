 ...
 * @subpackage admin
 */
class GenericDistributionProviderConfigureAction extends BorhanApplicationPlugin
{
	protected $client;
	...
	{
		$this->saveProviderAction($providerId, $form, 'submit', Borhan_Client_ContentDistribution_Enum_DistributionAction::SUBMIT);
		$this->saveProviderAction($providerId, $form, 'update', Borhan_Client_ContentDistribution_Enum_DistributionAction::UPDATE);
		$this->saveProviderAction($providerId, $form, 'delete', Borhan_Client_ContentDistribution_Enum_DistributionAction::DELETE);
		$this->saveProviderAction($providerId, $form, 'fetchReport', Borhan_Client_ContentDistribution_Enum_DistributionAction::FETCH_REPORT);
	}
	...
	public function saveProviderAction($providerId, Form_GenericProviderConfiguration $form, $action, $actionType)
	{
		...
		{
			$actionObject = new Borhan_Client_ContentDistribution_Type_GenericDistributionProviderAction();
		...
		try
		{
			if($providerId)
			{
				if ($request->isPost())
				{
					...
					$genericDistributionProvider = $form->getObject("Borhan_Client_ContentDistribution_Type_GenericDistributionProvider", $request->getPost());
