 ...
 * @subpackage admin
 */
class GenericDistributionProvidersListAction extends BorhanApplicationPlugin implements IBorhanAdminConsolePublisherAction
{
	...
	public function doAction(Zend_Controller_Action $action)
	{
		...
		// init filter
		$genericProviderFilter = new Borhan_Client_ContentDistribution_Type_GenericDistributionProviderFilter();
