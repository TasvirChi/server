 ...
 * @subpackage admin
 */
class Borhan_View_Helper_EntryInvestigateDistribution extends Borhan_View_Helper_PartialViewPlugin
{
	private $entryId;
	private $partnerId;
	...
	protected function getDataArray()
	{
		...
		$filter = new Borhan_Client_ContentDistribution_Type_EntryDistributionFilter();
		...
		if(count($distributionIds))
		{
			try
			{
				...
				$filter->fileObjectTypeEqual = Borhan_Client_Enum_FileSyncObjectType::ENTRY_DISTRIBUTION;
