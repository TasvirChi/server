 ...
 * @subpackage Admin
 */
class VirusScanListAction extends BorhanApplicationPlugin implements IBorhanAdminConsolePublisherAction
{
	...
	{
		$filter = new Borhan_Client_VirusScan_Type_VirusScanProfileFilter ();
