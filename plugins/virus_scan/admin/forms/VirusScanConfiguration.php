...
class Form_Partner_VirusScanConfiguration extends Infra_Form
{
	public function init()
	{
		...
		$engineType = new Borhan_Form_Element_EnumSelect('engineType', array('enum' => 'Borhan_Client_VirusScan_Enum_VirusScanEngineType'));
		$engineType->setLabel('Engine Type:');
		$engineType->setRequired(true);
		$this->addElements(array($engineType));
		
		
		$actionIfInfected = new Borhan_Form_Element_EnumSelect('actionIfInfected', array('enum' => 'Borhan_Client_VirusScan_Enum_VirusFoundAction'));
		...
		$arr = array(
			Borhan_Client_Enum_EntryType::DATA => 'Data',
			Borhan_Client_Enum_EntryType::MEDIA_CLIP => 'Media Clip',
			Borhan_Client_Enum_EntryType::DOCUMENT => 'Document',
		);
