...
class Form_FeedDropFolderConfigureExtend_SubForm extends Form_DropFolderConfigureExtend_SubForm
{
	...
	public function populateFromObject($dropFolder)
	{
		...
		/* @var $dropFolder Borhan_Client_DropFolder_Type_FeedDropFolder */
	...
	{
		/* @var $object Borhan_Client_DropFolder_Type_FeedDropFolder */
		$feedItemInfoForm = $this->getSubForm('feedItemInfo');
		
		/* @var $feedItemInfoForm Form_FeedItemInfoConfigureExtend */
		$object->feedItemInfo = $feedItemInfoForm->getObject ('Borhan_Client_FeedDropFolder_Type_FeedItemInfo',$properties, false );
