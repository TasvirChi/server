<?php
require_once( __DIR__ . '/BorhanMediaServerClientException.class.php');

/**
 * @package External
 * @subpackage WSDL
 */
class BorhanMediaServerClient extends nusoap_client
{
	...
	{
		if ($this->getError())
			throw new BorhanMediaServerClientException("BorhanMediaServerClient error calling operation: [".$this->operation."], error: [".$this->getError()."], request: [".$this->request."], response: [".$this->response."]");
	}
}
