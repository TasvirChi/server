...
mysql -h${DB} borhan -uborhan -pborhan < www_res.sql
...
##mysql -h${DBSTATS} borhan_stats -uroot -proot < ip_res.sql
...
##mysql -h${DBSTATS} borhan_stats -uroot -proot < cookie_res.sql
