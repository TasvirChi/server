...
*/
		...
		BorhanLog::log( "mySmartPager get [" . $this->m_criteria_class . "] [$cache_key] [" . $this->m_count_came_from_cache . "] [$cached_count]" );
	...
	private function setCountInCache ( $count_to_cache )
	{
		...
		BorhanLog::log( "mySmartPager set [" . $this->m_criteria_class . "] [$cache_key] [" . $this->m_count_came_from_cache . "] [$count_to_cache]" );
