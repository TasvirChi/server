...
(
	...
	(
		...
		JOIN borhandw.dwh_dim_partners dim_partner ON aggr_single_partner.partner_id=dim_partner.partner_id
		JOIN borhandw.dwh_dim_partner_type dim_partner_type ON dim_partner.partner_type_id=dim_partner_type.partner_type_id
	WHERE
