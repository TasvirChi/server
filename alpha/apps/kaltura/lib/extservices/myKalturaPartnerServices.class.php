 ...
 */
class myBorhanPartnerServices extends myBorhanServices implements IMediaSource
{
	const AUTH_SALT = "myBorhanPartnerServices:gogog123";
	const AUTH_INTERVAL = 3600;
	
	protected $id = entry::ENTRY_MEDIA_SOURCE_BORHAN_PARTNER;
