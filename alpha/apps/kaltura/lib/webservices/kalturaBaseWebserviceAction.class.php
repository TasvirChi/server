<?php
require_once ( __DIR__ . "/borhanWebserviceRenderer.class.php" );
/**
 * This class will make common tasks in the action classes much easier.
 *
 */
abstract class borhanBaseWebserviceAction extends borhanAction
{
	...
	{
		$renderer = new borhanWebserviceRenderer( $this );
