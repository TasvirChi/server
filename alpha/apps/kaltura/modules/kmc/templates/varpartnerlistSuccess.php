...
#bmcSubMenu { margin: 1px 0 27px; display:table; zoom:1;}
 #bmcSubMenu li { float:left; display:inline; list-style: none inside none; padding-left:9px; height:19px;}
  #bmcSubMenu li a, #bmcSubMenu li a:active, #bmcSubMenu li a:visited { height:19px; padding: 1px 12px 0 4px; display:block; font: bold 12px arial,sans-serif; color:#666; text-decoration:none;}
  #bmcSubMenu li a:hover { color:#000;}
#bmcSubMenu li.active { margin-top:1px; background:url(<?php echo $service_url; ?>/api_v3/system/images/jellybean.png) 0 0 no-repeat;}
#bmcSubMenu li.active a { font-weights:normal; color:#fff; background:url(<?php echo $service_url; ?>/api_v3/system/images/jellybean.png) right 0 no-repeat;}

</style>
	<div id="bmcHeader">
     <img src="<?php echo $service_url; ?>/lib/images/bmc/varpages_logo.png" alt="Borhan Management Console" />
     <ul>
...
<div id="varpartnerlist">
	...
	<h3 class="small"><a href="<?php echo $varBmcUrl; ?>" target="bmc_<?php echo $me->getId();?>">Login to your BMC account</a></h3>
	<h3 class="other">Click 'Login' to open publisher's BMC in a new window</h3>
	<div id="partnerList">
		<table>
...
?>
			<tr <?php echo $tr_class; ?>>
				...
				<td><a href="<?php echo $arr['bmcLink']; ?>" target="bmc_<?php echo $partnerId;?>">bmc login</a></td>
			</tr>
<?php
		$i++;
	}
...
function logout()
{
	...
	location = "<?php echo $service_url; ?>/index.php/bmc/varlogin";
