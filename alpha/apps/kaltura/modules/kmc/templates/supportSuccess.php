	  ...
	  body { background:#<?php echo $bodyBgColor; ?>;}
		...
		form { padding: 15px; #margin: -20px 0 0; background:#<?php echo $bodyBgColor; ?>}
		 ...
		 button { height:24px; padding: 0 13px 1px; border: solid 1px #B7BABC; margin: 0 auto 5px; #margin-top:21px;
				 background: url(/lib/images/bmc/bmc_sprite.png) no-repeat -57px -153px; /* -94px -152px */ cursor:pointer; color:#2B2B2B;}
...
<div id="thx">
	...
	<p>In the mean time, you may wish to <a href="http://www.borhan.org/search" target="_blank">browse the forums, guides and documentation on&nbsp;borhan.org</a></p>
	<?php } else { ?>
...
<div id="wrapper"> 
	<form action="" method="POST" name="support_form" id="support_form">
		...
		<fieldset>  
			...
			<p><label>* Partner Id: <input type="text" class="required" name="partner_id" id="partner_id" value="<?php echo $pid; ?>" /><img src="http://www.borhan.com/lib/images/bmc/error.jpg" height="20" width="20" alt="error" /></label></p> 
            <p><label>* Your Full Name: <input type="text" class="required" name="your_name" id="your_name" /><img src="http://www.borhan.com/lib/images/bmc/error.jpg" height="20" width="20" alt="error" /></label></p> 
            <p><label>* Email: <input type="text" class="required" name="email" id="email" value="<?php echo $email; ?>" /><img src="http://www.borhan.com/lib/images/bmc/error.jpg" height="20" width="20" alt="error" /></label></p> 
            <p><label id="checkbox">* Confirm email: <input type="checkbox" class="required" id="confirm_email" value="confirmed" /><em>&nbsp;This is the (only) email to which we will respond</em><img src="http://www.borhan.com/lib/images/bmc/error.jpg" height="20" width="20" alt="error" /></label></p>
		</fieldset> 
		...
		<fieldset> 
			...
			<p><label>* Component/ Feature:
					<select id="00N70000002RZpf" name="00N70000002RZpf" class="required"> 
						...
						<option value="BMC User Interface">BMC User Interface</option>
					...
					<img src="http://www.borhan.com/lib/images/bmc/error.jpg" height="20" width="20" alt="error" /></label></p> 
			...
			<p> 
				<label>* Subject:
					...
					<img src="http://www.borhan.com/lib/images/bmc/error.jpg" height="20" width="20" alt="error" /> 
				</label> 
			</p> 
			<p> 
				<label>* Description:
...
<!--			<p>
		...
		<fieldset> 
			...
			<p><label>Borhan CMS Extension:
					<select name="00N70000002RZmb" id="00N70000002RZmb"> 
						<option value="None" selected="selected">None</option> 
						<option value="Borhan Management Console">Borhan Management Console</option> 
...
?>
<div id="free">
	<p>Go to borhan.org for <a target="_blank" href="http://www.borhan.org/search">great community support</a></p>
	<p><a target="_blank" href="http://corp.borhan.com/about/contact?subject=Upgrade">Contact us</a> to learn more about our<br />paid Professional Services packages</p>
	<button onClick="<?php echo $closeFunction; ?>;">OK</button>
</div>
<script type="text/javascript" >
