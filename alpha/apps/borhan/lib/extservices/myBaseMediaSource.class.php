...
abstract class myBaseMediaSource implements IMediaSource 
{
	...
	const AUDIO_THUMB_URL = "http://www.borhan.com/images/search/img_sound.png";
	...
	protected $logo = "http://www.borhan.com";
...
*/
	...
	protected static function getBorhanMediaType ( $service_media_type )
	{
	...
	protected function hitUrl ( $url , $params=null , $user_agent =null)
	{
		...
		{
			BorhanLog::log ( __METHOD__ . ": error hitting url [$url] with params:" . print_r ( $params ) );
		}	
		curl_close($ch);	
	}
}
