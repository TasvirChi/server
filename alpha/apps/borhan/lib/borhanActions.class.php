...
abstract class borhanActions extends borhanAction
{
	/**
	...
	public function execute()
	{
		...
		{
			// action not found
			$error = 'borhanAction initialization failed for module "%s", action "%s". You must create a "%s" method.';
		...
		{
			$this->getContext()->getLogger()->info('{borhanAction} call "'.get_class($this).'->'.$actionToRun.'()'.'"');
		}
