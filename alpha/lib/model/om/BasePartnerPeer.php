...
abstract class BasePartnerPeer {
	...
	/** the column name for the BMC_VERSION field */
	const BMC_VERSION = 'partner.BMC_VERSION';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PartnerPeer::BMC_VERSION);
	}
