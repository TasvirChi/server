...
interface PermissionName extends BaseEnum
{
	...
	const FEATURE_BORHAN_LIVE_STREAM = 'FEATURE_BORHAN_LIVE_STREAM';
	const FEATURE_BORHAN_LIVE_DISABLE_SMART_TRANSCODING = 'FEATURE_BORHAN_LIVE_DISABLE_SMART_TRANSCODING';
	const FEATURE_BORHAN_LIVE_STREAM_TRANSCODE = 'FEATURE_BORHAN_LIVE_STREAM_TRANSCODE';
	const FEATURE_BORHAN_LIVE_STREAM_HD_FLAVORS = 'FEATURE_BORHAN_LIVE_STREAM_HD_FLAVORS';
	const FEATURE_BORHAN_LIVE_STREAM_HD_PLUS_FLAVORS = 'FEATURE_BORHAN_LIVE_STREAM_HD_PLUS_FLAVORS';
	const FEATURE_LIVE_STREAM_RECORD = 'FEATURE_LIVE_STREAM_RECORD';
	const FEATURE_LIVE_STREAM_BORHAN_RECORDING = 'FEATURE_LIVE_STREAM_BORHAN_RECORDING';
	...
	const FEATURE_UGC_BCW = 'FEATURE_UGC_BCW';
	...
	const FEATURE_DISABLE_BMC_LIST_THUMBNAILS = 'FEATURE_DISABLE_BMC_LIST_THUMBNAILS';
	const FEATURE_DISABLE_BMC_DRILL_DOWN_THUMB_RESIZE = 'FEATURE_DISABLE_BMC_DRILL_DOWN_THUMB_RESIZE';
	const FEATURE_DISABLE_BMC_BDP_ALERTS = 'FEATURE_DISABLE_BMC_BDP_ALERTS';
	const FEATURE_BMC_DRILLDOWN_TAGS_COLUMN = 'FEATURE_BMC_DRILLDOWN_TAGS_COLUMN';
	const FEATURE_BMC_ENFORCE_HTTPS = 'FEATURE_BMC_ENFORCE_HTTPS';
	...
	const FEATURE_BMC_ALLOW_FRAME = 'FEATURE_BMC_ALLOW_FRAME';
	...
	const DYNAMIC_FLAG_BMC_CHUNKED_CATEGORY_LOAD = 'DYNAMIC_FLAG_BMC_CHUNKED_CATEGORY_LOAD';
	...
	const BMC_ACCESS = 'BMC_ACCESS';
	const BMC_READ_ONLY = 'BMC_READ_ONLY';
	...
	const SYSTEM_ADMIN_PUBLISHER_BMC_ACCESS = 'SYSTEM_ADMIN_PUBLISHER_BMC_ACCESS';
