...
// widget page
function borhanInitModalBox ( url, options ) {
//alert("borhanInitModalBox ( " + url + "," + options + ")");
//	borhanCloseModalBox();
...
//		$("#overlay").click(function(){ borhanCloseModalBox(); });
	}
...
function borhanRefreshTop () {
	if ( this != window.top )
	{
		window.top.borhanRefreshTop();
		return false;
	}
