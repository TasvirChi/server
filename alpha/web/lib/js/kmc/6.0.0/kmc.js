...
(function(bmc) {
	...
	Preview.getEmbedFlashVars = function(previewService, addKs) {
		...
		if(playlistId) {
			...
			if(bmc.functions.versionIsAtLeast(bmc.vars.min_bdp_version_for_playlist_api_v3, player.swf_version) 
...
bmc.vars.api_host = bmc.vars.host + bmc.vars.port;
