...
foreach($partnerIds as $partnerId)
{
	...
	{
		BorhanLog::info('No disabled delivery types for partner '.$partnerId);
		continue;
	}

	BorhanLog::info('Disabled delivery types for partner id '.$partnerId.': '.implode(', ',$disabledDeliverTypes));
