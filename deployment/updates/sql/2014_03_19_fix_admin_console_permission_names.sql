...
UPDATE permission SET friendly_name = 'Publisher BMC access' WHERE partner_id = -2 AND name = 'SYSTEM_ADMIN_PUBLISHER_BMC_ACCESS' limit 1;
...
UPDATE permission SET friendly_name = 'BMC read only access' WHERE partner_id = 0 AND name = 'BMC_READ_ONLY' limit 1;
