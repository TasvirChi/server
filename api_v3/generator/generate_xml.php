...
$xmlFileName = "$outputPathBase/BorhanClient.xml";

BorhanLog::info("Using code introspection to generate XML schema");
$xmlGenerator = new XmlClientGenerator();
$xmlGenerator->generate();

$files = $xmlGenerator->getOutputFiles();
file_put_contents($xmlFileName, $files["BorhanClient.xml"]);

BorhanLog::info("XML generated: $xmlFileName");
