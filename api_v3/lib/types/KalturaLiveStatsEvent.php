<?php
/**
 * Will hold data from the Borhan Player components to be passed on to the live analytics system
 * @package api
 * @subpackage objects
 */
class BorhanLiveStatsEvent extends BorhanObject 
{
