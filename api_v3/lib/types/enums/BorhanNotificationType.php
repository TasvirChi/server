 ...
 * @subpackage enum
 */
class BorhanNotificationType extends BorhanEnum 
{
    const ENTRY_ADD = 1;
	...
	public static function getDescriptions()
	{
		return array(
			...
			self::USER_ADD => "The <i>user_add</i> notification is being sent to notify that a specific user was added to the Borhan DB.",
