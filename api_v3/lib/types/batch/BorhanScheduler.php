 ...
 * @subpackage objects
 */
class BorhanScheduler extends BorhanObject 
{
	/**
	 ...
	 *  
	 * @var BorhanSchedulerStatusArray
	 * @readonly
	 */
	public $statuses;
	...
	public function doFromObject($dbData, BorhanDetachedResponseProfile $responseProfile = null)
	{
		...
		if(is_array($statusesArray))
			$this->statuses = BorhanSchedulerStatusArray::fromValuesArray($statusesArray, $this->id, $this->configuredId);
	...
	public function statusFromObject($dbData)
	{
		...
		$this->workers = BorhanSchedulerWorkerArray::statusFromSchedulerWorkerArray($dbData->getWorkers());
	...
	public function toObject($dbData = null, $props_to_skip = array()) 
	{
		...
		if(!is_null($this->statuses) && $this->statuses instanceof BorhanSchedulerStatusArray)
