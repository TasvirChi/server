<h2>Overview</h2>
<p>
	Borhan XML Schema Definitions (XSDs) are standard W3C XSD version 1.0 formatted documents that define the structure of Borhan’s XML-formatted integration interfaces.
</p>
<p>
	Publishers and developers may use the schemas when applying or developing XML-based content management-related integrations with the Borhan Platform. The Borhan XML-based interfaces related to content management include bulk content ingestion, cue points handling, and content syndication.
</p>
...
<ol>
	<li>
		XMLs that are generated by the Borhan server and as such are fully compliant with their schema definition.<br/> 
		<b>Examples:</b> Syndication Feed XMLs, Bulk Upload Results XMLs, Cue Point Serve XMLs
	</li>
	<li>
		XMLs that are submitted to the Borhan server<br/>
		<b>Examples:</b> Bulk Upload XMLs, Cue Point Ingest XMLs, Drop Folder XMLs<br/>
		Each XML document and file submitted to the Borhan server is validated against its schema to ensure that a correct server action is committed. The following levels of validation apply:
		<ol type="a">
