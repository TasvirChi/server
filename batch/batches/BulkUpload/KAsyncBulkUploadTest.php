...
class KAsyncBulkUploadTest extends PHPUnit_Framework_TestCase
{
	...
	public function testICalWithRules()
	{
		...
		$this->assertEquals(BorhanScheduleEventRecuranceFrequency::YEARLY, $rule->frequency, "frequency [$rule->frequency]");
		...
		$this->assertEquals(BorhanScheduleEventRecuranceFrequency::DAILY, $rule->frequency, "frequency [$rule->frequency]");
		...
		$this->assertEquals(BorhanScheduleEventRecuranceFrequency::WEEKLY, $rule->frequency, "frequency [$rule->frequency]");
		$this->assertEquals(10, $rule->count, "count [$rule->count]");
		...
		$this->assertEquals(BorhanScheduleEventRecuranceFrequency::MONTHLY, $rule->frequency, "frequency [$rule->frequency]");
		...
		$this->assertEquals(BorhanScheduleEventRecuranceFrequency::HOURLY, $rule->frequency, "frequency [$rule->frequency]");
		$this->assertEquals(3, $rule->interval, "interval [$rule->interval]");
		$this->assertEquals($until, $rule->until, "until [$rule->until]");
		

		$rule = $this->doTestICalWithRules('FREQ=MINUTELY;INTERVAL=15;COUNT=6');
		$this->assertEquals(BorhanScheduleEventRecuranceFrequency::MINUTELY, $rule->frequency, "frequency [$rule->frequency]");
