...
class Form_Delivery_DeliveryProfileConfiguration extends Infra_Form
{
	public function init()
	{
		...
		$deliveryStatus = new Borhan_Form_Element_EnumSelect('status', array('enum' => 'Borhan_Client_Enum_DeliveryStatus'));
		...
		$type = new Borhan_Form_Element_EnumSelect('type', array('enum' => 'Borhan_Client_Enum_DeliveryProfileType'));
		$type->setLabel('Delivery profile Type*:');
		$this->addElements(array($type));
		
		$streamerType = new Borhan_Form_Element_EnumSelect('streamerType', array('enum' => 'Borhan_Client_Enum_PlaybackProtocol'));
