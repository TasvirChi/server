...
class Form_Widget extends Infra_Form
{
	public function init()
	{
		...
		$this->addElement('select', 'creation_mode', array(
			...
			'required'		=> true,
			'multiOptions' 		=> array(
				Borhan_Client_Enum_UiConfCreationMode::ADVANCED => 'Advanced',
				Borhan_Client_Enum_UiConfCreationMode::WIZARD => 'AppStudio Wizard',
			)
		));
	...
	public function setEditorButtons()
	{
		...
		$enableVisualEditor = Zend_Registry::get('config')->settings->enableBCWVisualEditor;
		if (($this->getValue('obj_type') == Borhan_Client_Enum_UiConfObjType::CONTRIBUTION_WIZARD) && ( is_null($enableVisualEditor) || $enableVisualEditor)) 
