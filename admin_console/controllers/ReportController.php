...
class ReportController extends Zend_Controller_Action
{
	public function listAction()
	{
		...
		$reportFilter->orderBy = Borhan_Client_Enum_ReportOrderBy::CREATED_AT_DESC;
		...
		$paginatorAdapter = new Borhan_FilterPaginatorWithPartnerLoader($adminConsolePlugin->reportAdmin, "listAction", null, $reportFilter);
	...
	public function createAction()
	{
		...
		if ($request->isPost())
		{
			...
			{
				$report = $form->getObject('Borhan_Client_Type_Report', $request->getPost());
	...
	public function editAction()
	{
		...
		if ($request->isPost())
		{
			if ($form->isValid($request->getParams()))
			{
				$reportUpdate = $form->getObject('Borhan_Client_Type_Report', $request->getPost());
	...
	{
		$reportFilter = new Borhan_Client_Type_ReportFilter();
		$partnerFilter = null;
	...
	public function testAction()
	{
		...
		if (is_array($params))
		{
			...
			{
				$keyValue = new Borhan_Client_Type_KeyValue();
				$keyValue->key = $key;
