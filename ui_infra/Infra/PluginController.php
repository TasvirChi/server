...
class Infra_PluginController extends Zend_Controller_Action
{
	...
	{
		BorhanLog::debug("Called method [$method] with args [" . print_r($args, true) . "]");
		...
		if($actionController && $actionController instanceof BorhanApplicationPlugin)
	...
	public function imgAction()
	{
		...
		if(!$plugin || !($plugin instanceof IBorhanApplicationImages))
		{
